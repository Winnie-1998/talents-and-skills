...
if (isset($_GET['approve'])) {
	$id =$_GET['approve'];
	$adn = "UPDATE talentbooking SET status='Approved' WHERE talentname='$id'";
...
if (isset($_GET['deny'])) {
	$id =$_GET['deny'];
	$adn = "UPDATE talentbooking SET status='Denied' WHERE talentname='$id'";
	$stmt = $mysqli->prepare($adn);
	$stmt->bind_param('i', $id);
	$stmt->execute();
	$stmt->close();
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Approve  Bookings</h2>
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
                                                    $aid = $_SESSION['id'];
                                                    $ret = "select * from talentbooking WHERE targetid='$aid' && status='Pending'";
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td> <a href="approvemybookings.php?approve=<?php echo $row->talentname;?>" class="btn btn-success">Approve  </a>   <a href="approvemybookings.php?deny=<?php echo $row->talentname;?>" class="btn btn-danger">Deny  </a></td>
                                                        </tr>
                                                    <?php
                                                        $cnt = $cnt + 1;
                                                    } ?>
