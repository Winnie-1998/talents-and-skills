										...
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
													...
													$stmt1->close(); */
													?>
													<div class="stat-panel-number h1 "><?php //echo $count1; ?>0</div>
													<div class="stat-panel-title text-uppercase">Total Bookings </div>
												</div>
											</div>
											<a href="managebooking.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
													<?php
												/*	$result2 = "SELECT count(*) FROM payment ";
													...
													$stmt2->close(); */
													?>
													<div class="stat-panel-number h1 "><?php //echo $count2; ?>Ksh. 0</div>
													<div class="stat-panel-title text-uppercase">Total Payment</div>
												</div>
											</div>
											<a href="managepayment.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
